...
This statistic is not expressed as a simple percentage and is not uniform across weapon categories. As a general rule:
...
The actual damage delivered after penetration depends on three combined factors: the weapon's Penetration Power; the material and thickness of the obstacle (thin drywall absorbs little damage, while concrete or steel absorbs much more or blocks the shot entirely, with the total number of surfaces a single bullet can penetrate capped at four); and the distance the bullet has already traveled before and after penetration. Thin metal and drywall typically retain 40–70\% of the bullet's damage, whereas concrete or multi-layered walls can reduce it by 70–90\%, often rendering low-penetration weapons such as SMGs or pistols nearly useless.
...
This mechanic is the missing piece that explains why wallhacks represent such a disproportionate advantage, beyond simply "seeing through walls":
