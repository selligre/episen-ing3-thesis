...
\begin{figure}[H]
    ...
    \end{center}
    \caption{User Segmentation \& Acceptance Divide, highlighting the contrasting perspectives of competitive and casual players regarding intrusive anti-cheat measures.}
    \label{fig:fig6}
\end{figure}
