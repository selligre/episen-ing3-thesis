...
Third-party platforms already aggregate match telemetry into rich per-player behavioral profiles, as shown in Figure 18, demonstrating that demo-derived data is sufficiently granular to serve as a foundation for the suspicion-scoring pipeline developed in Chapter 3.
