...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \caption{Privilege rings in an OS' structure, highlighting the elevated access of kernel-level cheats in Ring 0 compared to user-mode applications in Ring 3}
        \label{fig:fig4}
    \end{figure}
